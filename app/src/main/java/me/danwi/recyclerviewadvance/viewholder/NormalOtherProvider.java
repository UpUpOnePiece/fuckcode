 ...
 * Time: 下午11:33
 */
@ItemProviderTag(viewType = 1, layout = R.layout.item_novel_other)
public class NormalOtherProvider extends BaseItemProvider<ItemModel, BaseViewHolder> {

    @Override
    public void convert(BaseViewHolder helper, ItemModel data, int position) {
        helper.setText(R.id.tv_novel_author, data.novel.novelName);
        helper.setText(R.id.tv_novel_book_name, data.novel.novelName);
    }
